...
$(function(){
	...
	setInterval(function(){
		var date=new Date();
		var houres=parseInt(date.getHours());

		if(0<=houres && houres<=6){
			timer="凌晨好,";
		}
		else if(6<houres && houres<=11){
			timer="上午好,";
		}
		else if(11<houres && houres<=13){
			timer="中午好,";
		}
		else if(13<houres && houres<=16){
			timer="下午好,";
		}
		else if(16<houres && houres<=18){
			timer="傍晚好,";
		}
		else if(18<houres && houres<=24){
			timer="晚上好,";
		}
		$("#timer").text(timer);
	},1000);
...
<body>
    ...
    <b>${userInfo.user_name}<span id="timer"></span>欢迎使用信息管理系统</b>
    <a href="#">帐号设置</a>
    </div>
    
    <div class="welinfo">
    <span><img src="images/time.png" alt="时间" /></span>
    <i>您上次登录的时间：${loginTime}</i> （不是您登录的？<a href="#">请点这里</a>）
    </div>
    ...
    <li><img src="images/ico01.png" /><p><a href="index.jsp">管理设置</a></p></li>
