...
<body style="background: url(images/topbg.gif) repeat-x;">
	...
	<ul class="nav">
		<li><a href="default.jsp" target="rightFrame" class="selected"><img
				src="images/icon01.png" title="工作台" />
				<h2>工作台</h2></a></li>
		<li><a href="imgtable.jsp" target="rightFrame"><img
				src="images/icon02.png" title="模型管理" />
				<h2>模型管理</h2></a></li>
		...
		<li><a href="tools.jsp" target="rightFrame"><img
				...
				<h2>常用工具</h2></a></li>
		<li><a href="computer.jsp" target="rightFrame"><img
				src="images/icon05.png" title="文件管理" />
				<h2>文件管理</h2></a></li>
		<li><a href="tab.jsp" target="rightFrame"><img
	...
	<div class="topright">
		<ul>
			...
			<li><a href="#">关于</a></li>
			<li>
			<s:if test="#session.userState==0"><a href="login.jsp" id="state" target="_parent">登陆</a></s:if>
			<s:else><a href="exit_main" id="state" target="_parent">退出</a></s:else>
			
			</li>
		</ul>

		<div class="user">
			<span>${userInfo.user_name}</span> <i>消息</i> <b>5</b>
		</div>
