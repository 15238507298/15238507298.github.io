...
<body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>广告管理
        ...
        <li><cite></cite><a href="searchMap" target="rightFrame">导航列表</a><i></i></li>
    ...
    <ul class="menuson">
        <li><cite></cite><a href="searchLYPage?lessonTypes.lessonType_id=1" target="rightFrame">课程管理</a><i></i></li>
        <li><cite></cite><a href="searchLessonsBefore" target="rightFrame">发布课程</a><i></i></li>

    </ul>    
    </dd>  
    
    
    <dd><div class="title"><span><img src="images/leftico04.png" /></span>留言管理</div>
    <ul class="menuson">
 
        <li><cite></cite><a href="searchW"  target="rightFrame">留言信息</a><i></i></li>
