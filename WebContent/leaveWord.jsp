...
<body>
	...
	<div class="rightinfo">
		...
		<div class="tools">
			...
			<ul class="toolbar">
				...
				<li><form id="searchWord">
					<input type="hidden" value="1" name="lword.leaveWord_id"></input>
					<input type="text" name="lword.leaveWord_name"
						style="height: 90%; margin: 0; padding: 0 15px;"></input>
					<span><img src="images/t04.png" /></span>
					<b id="searchButton">查询</b></form></li>
		...
		<table class="tablelist">
			...
			<tbody>
				<s:iterator value="#session.wordPage" var="lWord">
					<tr>
						...
						<td><a
							href="findWord?lword.leaveWord_id=${lWord.leaveWord_id}"
							class="tablelink">查看</a> <a class="wordSinRemove"
		...
		<input type="hidden" name="currenPage"
			value="<s:property value="lword.leaveWord_id" />"></input> <input
			type="hidden" name="bigPage"
			value="<s:property value="#session.wordS.size()/11+2" />"></input>
		<div class="pagin">
			<div class="message">
				共<i class="blue"><s:property value="#session.wordS.size()" /></i>条记录，当前显示第&nbsp;<i
					class="blue"><s:property value="lword.leaveWord_id" />&nbsp;</i>页
			</div>
			<ul class="paginList">
