				...
				.click(
						function() {
							...
							if (index > 1) {
								...
								window.location.href = 'searchLYPage?lessonTypes.lessonType_id='
										+ (parseInt(index) - 1);
	...
	<div class="rightinfo">
			...
			<ul class="toolbar">
				...
				<li><form id="searchWord">
						<span> <input type="text"
							name="lessonTypes.lessonType_name"
		...
		<center>
			<table style="width: 100%;" class="tablelist">
				...
				<tbody>
					<s:iterator value="#session.lessonTyps" var="mapsInfo">
						...
						<tr class="tables">
							...
							<td style="width: 30%;"><a
								href="findLessons?lessonTypes.lessonType_id=${mapsInfo.lessonType_id}&lessons.lessons_id=1">查看课程</a></td>
							<td><a
			...
			<input type="hidden" name="currenPage"
				value="<s:property value="lessonTypes.lessonType_id" />"></input> <input
				type="hidden" name="bigPage"
				value="<s:property value="#session.lessonTypesS.size()/11+1" />"></input>
			<div class="pagin">
				<div class="message">
					共<i class="blue"><s:property
							value="#session.lessonTypesS.size()" /></i>条记录，当前显示第&nbsp;<i
						class="blue"><s:property value="lessonTypes.lessonType_id" />&nbsp;</i>页
				</div>
				<ul class="paginList">
